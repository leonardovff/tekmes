! function() {
    ...
    console.log(opts);
    var html = {
        minimalistic: '<div id="ncf_sidebar" class="ncf_minimalistic ncf_up_style_theme_custom"><div class="ncf_sidebar_cont_scrollable"> <div class="ncf_sidebar_cont ncf_shrinked" style="min-height: 0px;"> <div class="ncf_form_wrapper ncf_form_1 ncf_default_form" data-index="1" style="display: block;"> <div class="ncf_sidebar_header"> <div class="ncf_sidebar_header_userinfo"> <div class="ncf_userpic"><img src="img/logo.jpg" alt=""></div> <div class="ncf_user_credentials"> <span class="ncf_user_firstname"></span> <span class="ncf_user_lastname">STARBUCKS</span> <span class="ncf_user_title">One person, one cup and one neighborhood at a time</span> </div> </div> <div class="ncf_sidebar_socialbar"> <ul> <li><a class="ncf_facebook" href="https://facebook.com" target="_blank"></a></li><li><a class="ncf_twitter" href="https://facebook.com" target="_blank"></a></li><li><a class="ncf_pinterest" href="https://facebook.com" target="_blank"></a></li> </ul> </div> </div> <div class="ncf_sidebar_content"> <div class="ncf_user_bio">It has always been, and will always be, about quality. We\'re passionate about ethically sourcing the finest coffee beans, roasting them with great care. We\'d like to hear your message! </div> <form class="ncf_form" action="" id="nk_form_1"> <input type="hidden" name="action" value="ncf_send_message"> <input type="hidden" name="ncf_form_index" value="1"> <div class="ncf_form_input_wrapper ncf_name_field ncf_ph"> <input type="text" name="ncf_name_field" id="ncf_name_field" data-rules="required|min[2]|max[32]" data-name="Your name"><label for="ncf_name_field">Your name *</label> </div> <div class="ncf_form_input_wrapper ncf_email_field ncf_ph"> <input type="email" name="ncf_email_field" id="ncf_email_field" data-rules="required|email" data-name="Your e-mail"><label for="ncf_email_field">Your e-mail *</label> </div> <div class="ncf_form_input_wrapper ncf_message_field ncf_ph"> <textarea name="ncf_message_field" id="ncf_message_field" cols="30" rows="10" data-rules="required" data-name="Your message"></textarea><label for="ncf_message_field">Your message *</label> </div> <div class="ncf_form_input_wrapper ncf_noselect"> <input type="checkbox" name="ncf_subscriber" id="ncf_subscriber"><label for="ncf_subscriber">Subscribe to our news?</label> </div> <div class="ncf_form_btn_wrapper"> <div class="ncf_question_wrapper ncf_ph"><input type="text" name="ncf_answer_field" id="ncf_answer_field" maxlength="2" data-rules="required|numeric|answer[14]" data-name="Answer"><label id="ncf_question" for="ncf_answer_field">8 + 6 = ?</label> </div> <a class="ncf_button ncf_color1" href="#"><span>Send</span></a> <input type="submit" value="Send"> </div> </form> <div class="ncf_form_result"></div> </div> </div> </div> </div> </div>',
        flat: '<div id="ncf_sidebar" class="ncf_flat ncf_up_style_theme_custom"><div class="ncf_sidebar_cont_scrollable"> <div class="ncf_sidebar_cont ncf_shrinked" style="min-height: 0px;"> <div class="ncf_form_wrapper ncf_form_1 ncf_default_form" data-index="1" style="display: block;"> <div class="ncf_sidebar_header"> <div class="ncf_sidebar_socialbar"> <ul> <li class="ncf_color1"><a class="ncf_facebook" href="https://facebook.com" target="_blank"></a></li> <li class="ncf_color2"><a class="ncf_twitter" href="https://facebook.com" target="_blank"></a></li> <li class="ncf_color3"><a class="ncf_pinterest" href="https://facebook.com" target="_blank"></a></li> <li class="ncf_color4"><a class="ncf_youtube" href="https://facebook.com" target="_blank"></a></li> <li class="ncf_color5"><a class="ncf_instagram" href="https://facebook.com" target="_blank"></a></li> <li class="ncf_color6"><a class="ncf_linkedin" href="https://facebook.com" target="_blank"></a></li> <li class="ncf_color7"><a class="ncf_gplus" href="https://facebook.com" target="_blank"></a></li> <li class="ncf_color8"><a class="ncf_rss" href="https://facebook.com" target="_blank"></a></li> </ul> </div> <div class="ncf_sidebar_header_userinfo ncf_color1"> <div class="ncf_userpic"><img src="img/ncf_userpic1.png" alt=""></div> <div class="ncf_user_credentials"> <span class="ncf_user_firstname"></span> <span class="ncf_user_lastname">Bo Horseman</span> <span class="ncf_user_title">Awesome horse who loves to play with children.</span> </div> </div>  </div> <div class="ncf_sidebar_content"> <div class="ncf_user_bio">C\'mon, drop me a line and try this form! </div> <form class="ncf_form" action="" id="nk_form_1"> <input type="hidden" name="action" value="ncf_send_message"> <input type="hidden" name="ncf_form_index" value="1"> <div class="ncf_form_input_wrapper ncf_name_field ncf_ph"> <input type="text" name="ncf_name_field" id="ncf_name_field" data-rules="required|min[2]|max[32]" data-name="Your name"><label for="ncf_name_field">Your name *</label> </div> <div class="ncf_form_input_wrapper ncf_email_field ncf_ph"> <input type="email" name="ncf_email_field" id="ncf_email_field" data-rules="required|email" data-name="Your e-mail"><label for="ncf_email_field">Your e-mail *</label> </div> <div class="ncf_form_input_wrapper ncf_message_field ncf_ph"> <textarea name="ncf_message_field" id="ncf_message_field" cols="30" rows="10" data-rules="required" data-name="Your message"></textarea><label for="ncf_message_field">Your message *</label> </div> <div class="ncf_form_input_wrapper ncf_noselect"> <input type="checkbox" name="ncf_subscriber" id="ncf_subscriber"><label for="ncf_subscriber">Subscribe to our news?</label> </div> <div class="ncf_form_btn_wrapper"> <div class="ncf_question_wrapper ncf_ph"><input type="text" name="ncf_answer_field" id="ncf_answer_field" maxlength="2" data-rules="required|numeric|answer[14]" data-name="Answer"><label id="ncf_question" for="ncf_answer_field">8 + 6 = ?</label> </div> <a class="ncf_button ncf_color1" href="#"><span>Send</span></a> <input type="submit" value="Send"> </div> </form> <div class="ncf_form_result"></div> </div> </div> </div> </div> </div>',
        aerial: '<div id="ncf_sidebar" class="ncf_aerial ncf_up_style_theme_custom"><div class="ncf_sidebar_cont_scrollable"> <div class="ncf_sidebar_cont ncf_shrinked" style="min-height: 0px;"> <div class="ncf_form_wrapper ncf_form_1 ncf_default_form" data-index="1" style="display: block;"> <div class="ncf_sidebar_header">  <div class="ncf_sidebar_socialbar"> <ul> <ul> <li><a class="ncf_facebook" href="https://facebook.com" target="_blank"></a></li><li><a class="ncf_twitter" href="https://facebook.com" target="_blank"></a></li><li><a class="ncf_pinterest" href="https://facebook.com" target="_blank"></a></li><li><a class="ncf_youtube" href="https://facebook.com" target="_blank"></a></li><li><a class="ncf_instagram" href="https://facebook.com" target="_blank"></a></li><li><a class="ncf_linkedin" href="https://facebook.com" target="_blank"></a></li><li><a class="ncf_gplus" href="https://facebook.com" target="_blank"></a></li><li><a class="ncf_rss" href="https://facebook.com" target="_blank"></a></li> </ul> </div><div class="ncf_sidebar_header_userinfo"> <div class="ncf_userpic"><img src="img/brucie.jpeg" alt=""></div> <div class="ncf_user_credentials"> <span class="ncf_user_firstname"></span> <span class="ncf_user_lastname">Bruce Almighty</span> <span class="ncf_user_title">Saving everything since 1980s.<br>I really do care.</span> </div> </div> </div> <div class="ncf_sidebar_content"> <div class="ncf_user_bio">Hello good sir! Send me a message and you will have my answer!</div> <form class="ncf_form" action="" id="nk_form_1"> <input type="hidden" name="action" value="ncf_send_message"> <input type="hidden" name="ncf_form_index" value="1"> <div class="ncf_form_input_wrapper ncf_name_field ncf_ph"> <input type="text" name="ncf_name_field" id="ncf_name_field" data-rules="required|min[2]|max[32]" data-name="Your name"><label for="ncf_name_field">Your name *</label> </div> <div class="ncf_form_input_wrapper ncf_email_field ncf_ph"> <input type="email" name="ncf_email_field" id="ncf_email_field" data-rules="required|email" data-name="Your e-mail"><label for="ncf_email_field">Your e-mail *</label> </div> <div class="ncf_form_input_wrapper ncf_message_field ncf_ph"> <textarea name="ncf_message_field" id="ncf_message_field" cols="30" rows="10" data-rules="required" data-name="Your message"></textarea><label for="ncf_message_field">Your message *</label> </div> <div class="ncf_form_input_wrapper ncf_noselect"> <input type="checkbox" name="ncf_subscriber" id="ncf_subscriber"><label for="ncf_subscriber">Subscribe to our news?</label> </div> <div class="ncf_form_btn_wrapper"> <div class="ncf_question_wrapper ncf_ph"><input type="text" name="ncf_answer_field" id="ncf_answer_field" maxlength="2" data-rules="required|numeric|answer[14]" data-name="Answer"><label id="ncf_question" for="ncf_answer_field">8 + 6 = ?</label> </div> <a class="ncf_button ncf_color1" href="#"><span>Send</span></a> <input type="submit" value="Send"> </div> </form> <div class="ncf_form_result"></div> </div> </div> </div> </div> </div>'
    };
